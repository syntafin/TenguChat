package de.tengu.chat.persistance;
...
import de.tengu.chat.crypto.axolotl.SQLiteAxolotlStore;
...
public class DatabaseBackend extends SQLiteOpenHelper {
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		if (oldVersion < 34 && newVersion >= 34) {
			...
			final File oldPicturesDirectory = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES)+"/TenguChat/");
			final File oldFilesDirectory = new File(Environment.getExternalStorageDirectory() + "/TenguChat/");
			final File newFilesDirectory = new File(Environment.getExternalStorageDirectory() + "/TenguChat/Media/TenguChat Files/");
			final File newVideosDirectory = new File(Environment.getExternalStorageDirectory() + "/TenguChat/Media/TenguChat Videos/");
			if (oldPicturesDirectory.exists() && oldPicturesDirectory.isDirectory()) {
				final File newPicturesDirectory = new File(Environment.getExternalStorageDirectory() + "/TenguChat/Media/TenguChat Images/");
