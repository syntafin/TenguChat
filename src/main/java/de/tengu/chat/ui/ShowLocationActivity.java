...
import de.tengu.chat.databinding.ActivityShowLocationBinding;
import de.tengu.chat.ui.util.LocationHelper;
import de.tengu.chat.ui.util.UriHelper;
import de.tengu.chat.ui.widget.Marker;
import de.tengu.chat.ui.widget.MyLocation;
...
public class ShowLocationActivity extends LocationActivity implements LocationListener {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			switch (action) {
				case "de.tengu.chat.location.show":
