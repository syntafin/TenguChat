...
import de.tengu.chat.databinding.FragmentConversationBinding;
...
import de.tengu.chat.entities.Conversational;
...
import de.tengu.chat.entities.MucOptions.User;
import de.tengu.chat.entities.Presence;
import de.tengu.chat.entities.ReadByMarker;
import de.tengu.chat.entities.Transferable;
import de.tengu.chat.entities.TransferablePlaceholder;
import de.tengu.chat.http.HttpDownloadConnection;
import de.tengu.chat.persistance.FileBackend;
import de.tengu.chat.services.MessageArchiveService;
import de.tengu.chat.services.QuickConversationsService;
import de.tengu.chat.services.XmppConnectionService;
import de.tengu.chat.ui.adapter.MediaPreviewAdapter;
import de.tengu.chat.ui.adapter.MessageAdapter;
import de.tengu.chat.ui.util.ActivityResult;
import de.tengu.chat.ui.util.Attachment;
import de.tengu.chat.ui.util.ConversationMenuConfigurator;
import de.tengu.chat.ui.util.DateSeparator;
import de.tengu.chat.ui.util.EditMessageActionModeCallback;
import de.tengu.chat.ui.util.ListViewUtils;
import de.tengu.chat.ui.util.MenuDoubleTabUtil;
import de.tengu.chat.ui.util.MucDetailsContextMenuHelper;
import de.tengu.chat.ui.util.PendingItem;
import de.tengu.chat.ui.util.PresenceSelector;
import de.tengu.chat.ui.util.ScrollState;
import de.tengu.chat.ui.util.SendButtonAction;
import de.tengu.chat.ui.util.SendButtonTool;
import de.tengu.chat.ui.util.ShareUtil;
import de.tengu.chat.ui.util.ViewUtil;
import de.tengu.chat.ui.widget.EditMessage;
import de.tengu.chat.utils.AccountUtils;
import de.tengu.chat.utils.Compatibility;
import de.tengu.chat.utils.GeoHelper;
import de.tengu.chat.utils.MessageUtils;
import de.tengu.chat.utils.NickValidityChecker;
import de.tengu.chat.utils.Patterns;
import de.tengu.chat.utils.QuickLoader;
import de.tengu.chat.utils.StylingHelper;
import de.tengu.chat.utils.TimeframeUtils;
import de.tengu.chat.utils.UIHelper;
import de.tengu.chat.xmpp.XmppConnection;
import de.tengu.chat.xmpp.chatstate.ChatState;
import de.tengu.chat.xmpp.jingle.JingleConnection;
import rocks.xmpp.addr.Jid;

import static de.tengu.chat.ui.XmppActivity.EXTRA_ACCOUNT;
import static de.tengu.chat.ui.XmppActivity.REQUEST_INVITE_TO_CONVERSATION;
import static de.tengu.chat.ui.util.SoftKeyboardUtils.hideSoftKeyboard;
import static de.tengu.chat.utils.PermissionUtils.allGranted;
import static de.tengu.chat.utils.PermissionUtils.getFirstDenied;
