...
import de.tengu.chat.ui.adapter.ConversationAdapter;
...
public class ConversationActivity extends XmppActivity
			...
			public void onPresenceSelected() {
				...
				switch (attachmentChoice) {
					...
					case ATTACHMENT_CHOICE_RECORD_VOICE:
						...
						fallbackPackageId = "de.tengu.chat.voicerecorder";
						break;
					case ATTACHMENT_CHOICE_LOCATION:
						intent.setAction("de.tengu.chat.location.request");
						fallbackPackageId = "de.tengu.chat.sharelocation";
						break;
				}
	...
	protected void attachFileDialog() {
		...
		if (new Intent("de.tengu.chat.location.request").resolveActivity(getPackageManager()) == null) {
