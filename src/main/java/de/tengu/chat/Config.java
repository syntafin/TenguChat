...
public final class Config {
	...
	public static final String LOGTAG = "tenguchat";

	public static final String BUG_REPORTS = "bugs@tengu.chat";


	public static final String DOMAIN_LOCK = "tengu.chat"; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "tengu.chat";
