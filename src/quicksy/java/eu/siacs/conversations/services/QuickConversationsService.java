...
public class QuickConversationsService extends AbstractQuickConversationsService {
    ...
    private static final String INSTALLATION_ID = "de.tengu.chat.installation-id";
